  ...
  useEffect(() => {
    async function fetchRule() {
      ...
      try {
        ...
        setSelectedTypes(rule.trigger_conditions.signal_types || []);
        setSelectedPriorities(rule.trigger_conditions.priorities || []);
        setKeywords(rule.trigger_conditions.keywords || []);
        setSelectedActions(rule.actions.map((a) => a.type));
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          >
            ...
            <div className="flex items-center justify-between p-3 bg-[var(--bg-secondary)] rounded-lg">
              <div>
                <p className="text-sm font-medium text-[var(--text-primary)]">Rule Status</p>
                <p className="text-xs text-[var(--text-tertiary)]">
                  {isActive ? "This rule is currently active" : "This rule is disabled"}
                </p>
              </div>
              <Button
                type="button"
